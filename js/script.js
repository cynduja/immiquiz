    ...
    //Taking values from the checkboxes on submit button
        ...
        $("#frm1").submit(function() {
            ...
            if($("#frm1 input:checkbox:checked").length>0) {
                ...
                //Importing externally from CSV
                    ...
                    options.fetch({
                     ...
                     function dosomething(options) {
                        ...
                        console.log(leng);
                        $("#results").append("<h1> Possible options for you are:</h1>");
                        for (var i=0; i<leng; i++) {
                            j = allVals[i];
                            $("#results").append("<div class = 'show'> <p> <b>You chose:</b> "+options[j-1].selection+"</p> <p> <b>And your possible option is:</b> "+options[j-1].result+"</p></div>");
                        }
                    }
                ...
                {
                    $("#noclickresults").append("<div class = 'show'> Sorry! You didn't check anything </div>");
                    $("#reload").show();
                }
